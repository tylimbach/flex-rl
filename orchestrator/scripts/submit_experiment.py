...
def run_local_job(command_args):
...
if __name__ == "__main__":
	...
	parser.add_argument("--mode", choices=["k8s", "local"], default="k8s")
	...
	command_args = ["python", "train.py", "--name", args.exp_name, "--config", args.config]
	...
	if args.mode == "k8s":
		...
		run_local_job(command_args)
		print(f"✅ Started {args.exp_name} locally")
